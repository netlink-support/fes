(function(a) {
    ...
    a.extend(a.fn.modal.Constructor.prototype, {
        ...
        showImage: function(b) {
            ...
            c.find(".modal-title").css({
                width: Math.max(b.width, 380)
            }),
            ...
            g && g.remove()), f.append(b), h = b.offsetWidth, c.trigger("display"), d ? c.is(":visible") ? a(b).on(a.support.transition.end, function(d) {
        ...
        show: function() {
            if (!this.isShown && this.$element.hasClass("modal-gallery")) {
                ...
                this.initGalleryEvents(), this.initLinks(), this.$links.length && (b.find(".modal-slideshow, .modal-prev, .modal-next").toggle(this.$links.length !== 1), b.toggleClass("modal-single", this.$links.length === 1), this.loadImage())
            }
