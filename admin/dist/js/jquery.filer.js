            ...
            var s = $(r),
                    ...
                    f = {
                            ...
                            for (var k in d) {
                                ...
                                if (f._assets.hasAttr(j)) {
                                    switch (d[k]) {
                                        ...
                                        case "uploadUrl":
                                            if (n.uploadFile)
                                                n.uploadFile.url = s.attr(j);
                                            break;
                                        case "uploadData":
                                            if (n.uploadFile)
                                                n.uploadFile.data = JSON.parse(s.attr(j));
                                            break;
                                        case "files":
                                        case "options":
                            ...
                            create: function (i) {
                                var file = f.files[i],
                                        ...
                                        opts = {
                                            ...
                                            intval: file.intval,
                                            groupwork: file.groupwork,
                                            reference: file.reference,
                                            reftextbox: file.reftextbox,
                                ...
                                setTimeout(function ()
                                {
                                    var inp = $(f._thumbCreator.renderContent(opts)).find('.pos_text').attr('id');
                                    if (typeof inp !== 'undefined')
                                    {
                                        document.getElementById(inp).value = parseInt(id) + parseInt(1);
                                    }
                                }, 100);
                        ...
                        _addToMemory: function (i) {
                            ...
                            if (n.addMore || f.files[i]._appended)
                                f._itFl[f._itFl.length - 1].input = s;
