$(document).ready(function () {
    ...
    $("#filer_input2").filer({
        ...
        uploadFile: {
            url: "ajax/ajax_upload.php?type=upload_project_image",
            ...
            success: function (data, itemEl, listEl, boxEl, newInputEl, inputEl, id) {
                ...
                } else
                {
                    ...
                    itemEl.find(".jFiler-item-text").append('<textarea placeholder="Image caption" name="image_caption_' + total_images + '" id="image_caption_' + total_images + '" rows="2" width="100%"></textarea><label><input style="display:none" class="popup-image-check" type="checkbox" name="image_popup_' + total_images + '" id="image_popup_' + total_images + '" value="1" />&nbsp;&nbsp;</label><input type="hidden" name="image_' + total_images + '" value="' + new_file_name + '" id="image_' + total_images + '"  /><input class="pos_text" value="' + total_images + '" type="hidden" name="image_position_' + total_images + '" id="image_position_' + total_images + '"  />');
                    //alert('end');
                }
            },
            error: function (el) {
    ...
    $("#filer_input3").filer({
        ...
        theme: "dragdropbox",
        templates: {
            box: '<ul class="jFiler-items-list jFiler-items-grid row" id="sortable1"></ul>',
            item: '<li class="jFiler-item col-lg-2 col-md-3 col-sm-3 col-xs-6 col-xxs-12">\
						<div class="jFiler-item-container">\
							<div class="jFiler-item-inner">\
								<div class="jFiler-item-thumb">\
            ...
            itemAppend: '<li class="jFiler-item col-lg-2 col-md-3 col-sm-3 col-xs-6 col-xxs-12">\
						<div class="jFiler-item-container">\
							<div class="jFiler-item-inner">\
								...
								<div class="jFiler-item-text">\
									<textarea placeholder="Image caption" name="drawing_caption_{{fi-intval}}" id="drawing_caption_{{fi-intval}}" rows="2" width="100%">{{fi-caption}}</textarea>\
                                                                        {{fi-popup}}\
                                                                        <input type="hidden" name="drawing_{{fi-intval}}" value="{{fi-name}}" id="drawing_{{fi-intval}}"  />\
                                                                        <input type="hidden" class="pos_text" value="" name="drawing_position_{{fi-intval}}" id="drawing_position_{{fi-intval}}"  />\
								</div>\
							</div>\
						</div>\
					</li>',
        ...
        uploadFile: {
            url: "ajax/ajax_upload.php?type=upload_project_drawing",
            data: null,
            type: 'POST',
            enctype: 'multipart/form-data',
            synchron: true,
                ...
                } else
                {
                    ...
                    $("#sortable1").sortable({
                        ...
                        stop: function (event, ui) {
                            ...
                            if (old_pos > new_pos)
                            {
                                $.each($('#sortable1 .jFiler-item'), function () {
                                    var this_pos = $(this).find('.pos_text').val();
                    ...
                    //$("#sortable").disableSelection();
                    total_drawings++;
                    $('#total_drawings').val(total_drawings);
                    itemEl.find(".jFiler-item-text").append('<textarea placeholder="Image caption" name="drawing_caption_' + total_drawings + '" id="drawing_caption_' + total_drawings + '" rows="2" width="100%"></textarea><label><input style="display:none" class="popup-image-check" type="checkbox" name="drawing_popup_' + total_drawings + '" id="drawing_popup_' + total_drawings + '" value="1" />&nbsp;&nbsp;</label><input type="hidden" name="drawing_' + total_drawings + '" value="' + new_file_name + '" id="drawing_' + total_drawings + '"  /><input class="pos_text" value="' + total_drawings + '" type="hidden" name="drawing_position_' + total_drawings + '" id="drawing_position_' + total_drawings + '"  />');
                    //alert('end');
                }
            },
            error: function (el) {
        ...
        onRemove: function (itemEl, file, id, listEl, boxEl, newInputEl, inputEl) {
            ...
            $.post("ajax/ajax_custom.php?type=remove_drawing", {file: file_name});
