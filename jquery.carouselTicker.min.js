...
!(function (e) {
    var t = {},
        i = { direction: "prev", mode: "horizontal", speed: 1, delay: 30, onCarouselTickerLoad: function () {} };
    e.fn.carouselTicker = function (n) {
        ...
        function a() {
            ...
            l.$list.on(l.eventTypes.mousedown, function (i) {
                ...
                e(i.target).off("click"),
                    ...
                    (l.intervalPointer = !1),
                    (t = !0),
                    o.on(l.eventTypes.mousemove, function (i) {
                        ...
                        l.touch &&
                            ...
                            "horizontal" === l.settings.mode ? (l.directionSwitcher = u >= 0 ? -1 : 1) : "vertical" === l.settings.mode && (l.directionSwitcher = d >= 0 ? -1 : 1),
                            (l.isMousemove = !0),
                            t &&
                                ("horizontal" === l.settings.mode
                                    ? (r - u >= 0 && 1 === l.directionSwitcher && (o.css("left", "-=" + l.itemsWidth), (r = -l.itemsWidth), (n = i.clientX || event.touches[0].pageX), (u = 0)),
                                      r - u <= -l.itemsWidth && -1 === l.directionSwitcher && (o.css("left", 0), (r = 0), (u = 0), (n = i.clientX || event.touches[0].pageX)),
                                      o.css("left", r - u + "px"))
                                    : "vertical" === l.settings.mode &&
                                      (c - d >= 0 && 1 === l.directionSwitcher && (o.css("top", "-=" + l.itemsHeight), (c = -l.itemsHeight), (s = i.clientY || event.touches[0].pageY), (d = 0)),
                                      c - d <= -l.itemsHeight && -1 === l.directionSwitcher && (o.css("top", 0), (c = 0), (d = 0), (s = i.clientY || event.touches[0].pageY)),
                                      o.css("top", c - d + "px")));
                    });
            }),
                l.$list.on(l.eventTypes.mouseup, function (i) {
                    var n = e(i.target);
                    i.preventDefault(),
                        (n.attr("href") || (n.parents().attr("href") && l.isMousemove)) &&
                            n.on("click", function (e) {
                                e.preventDefault();
                            }),
                        (t = !1),
                        (l.isMousemove = !1),
                        (l.settings.direction = 1 === l.directionSwitcher ? "next" : "prev"),
                        e(this).off(l.eventTypes.mousemove),
                        l.touch && e(document).off("touchmove"),
        ...
        var d = function () {
                (l.settings = e.extend({}, i, n)),
                    ...
                    (l.itemsHeight = 0),
                    (l.childsHeight = 0),
                    (l.$list = u.children("ul")),
                    (l.$items = l.$list.children("li")),
                    (l.isInitialize = !1),
                    (l.isMousemove = !1),
                    (l.$parent = u.parent()),
                    ...
                    (l.touch = "ontouchstart" in document.documentElement ? !0 : !1),
                    (l.eventTypes = { mousedown: l.touch ? "touchstart" : "mousedown", mousemove: l.touch ? "touchmove" : "mousemove", mouseup: l.touch ? "touchend" : "mouseup" }),
                    v();
            },
            v = function () {
                function t() {
                    u.children().hasClass(l.wrapCls) ||
                        (e("<div class='" + l.loaderCls + "'></div>").appendTo(u),
                        u.find("." + l.wrapCls).css({ position: "relative" }),
                        l.$list.wrap(
                ...
                "horizontal" === l.settings.mode
                    ? (s(), l.itemsWidth > l.$parent.width() && (u.find("." + l.wrapCls).css({ width: l.$parent.width() + "px" }), l.$list.css({ width: 2 * l.itemsWidth, left: 0 }), t()))
                    : "vertical" === l.settings.mode && (o(), l.itemsHeight > l.$parent.height() && (u.find("." + l.wrapCls).css({ height: l.$parent.height() + "px" }), l.$list.css({ height: 2 * l.itemsHeight, top: 0 }), t())),
                    l.isInitialize &&
            ...
            p = function () {
                u.find("." + l.loaderCls).length && u.find("." + l.loaderCls).remove(),
                    (l.intervalPointer = setInterval(function () {
                        m();
                    }, l.settings.delay)),
                    r(),
            ...
            m = function () {
                ...
                l.$list.css(e, "+=" + l.directionSwitcher * l.settings.speed + "px"),
                    "prev" === l.settings.direction && Math.abs(parseInt(l.$list.css(e))) >= t && l.$list.css(e, 0),
                    "next" === l.settings.direction && parseInt(l.$list.css(e)) >= 0 && l.$list.css(e, -t + "px");
            };
        return (
            (h.resizeTicker = function () {
            ...
            (h.destructor = function () {
                u.find("." + l.cloneCls).remove(),
                    u.find("." + l.wrapCls).length && (l.$list.unwrap(), l.$list.css({ left: "auto", position: "static", width: "auto" }), u.css({ width: "auto", position: "static" })),
                    clearInterval(l.intervalPointer),
                    (l.isInitialize = !1),
                    (l.intervalPointer = !1);
            }),
